...
exilium Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadRPCServer : Remote procedure call handler, listens on port 20221 for connections and services them.
...
However, in open source software such as exilium Core, where everyone uses
...
pay attention to for reviewers of exilium Core code.

General exilium Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: exilium Core uses tinyformat, which is type safe. Leave them out to avoid confusion
