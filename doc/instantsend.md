...
This mechanism has been integrated into Bitcore-Node-exilium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/exilium/insight-api-exilium#web-socket-api](https://github.com/exilium/insight-api-exilium#web-socket-api)
* API: [https://github.com/exilium/insight-api-exilium#instantsend-transactions](https://github.com/exilium/insight-api-exilium#instantsend-transactions)
...
By default, the exilium Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the exilium Core daemon:
