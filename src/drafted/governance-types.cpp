...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "exiliumNetwork") type = exiliumNetwork;
    if(strType == "exiliumNetworkVariable") type = exiliumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == exiliumNetwork) s = "exiliumNetwork";
    if(type == exiliumNetworkVariable) s = "exiliumNetworkVariable";
