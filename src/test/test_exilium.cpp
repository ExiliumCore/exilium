...
#define BOOST_TEST_MODULE exilium Test Suite

#include "test_exilium.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_exilium_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
