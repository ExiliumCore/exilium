    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("exilium-light"), QVariant("light"));
    ui->theme->addItem(QString("exilium-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("exilium-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("exilium-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("exilium-traditional"), QVariant("trad"));
