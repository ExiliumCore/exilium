    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Exilium Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Exilium Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  exilium-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the exilium in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 exilium, 0.1 exilium, 1 exilium and 10 exilium -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://exilium.atlassian.net/wiki/display/DOC/PrivateSend\">https://exilium.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Exilium Core is shutting down...") + "<br /><br />" +
